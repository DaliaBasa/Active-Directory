...
Open the 'Storage' tab and click on the empty storage device (has a disk shaped icon).
Then, click on the disk shaped icon on the right side and click 'Choose a disk file...'
Insert the Windows Server ISO file.
